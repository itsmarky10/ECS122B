...
public class DeterministicSelect {
    ...
    private int deterministic_select(int[] array, int elementPos) {
        DeterministicSelect dObj = new DeterministicSelect();
        if(array.length <= 10) {
    ...
    public static void main(String[] args) {
        ...
        DeterministicSelect selectObj = new DeterministicSelect();
        ...
        if(kOrder <= 0 || kOrder > array.length) {
            System.out.println("ERROR DSelect: kOrder value is " + kOrder + " and array is of size " + array.length);
            System.exit(1);
        }
